...
EXECUTE.
  ...
  RELIABILITY 
  /VARIABLES=PostQ1 PostQ3 PostQ5 PostQ6 PostQ7 PostQ8 PostQ9 PostQ11  
      PostQ16 PostQ17 PostQ18 PostQ19 PostQ20 
  /SCALE('ALL VARIABLES') ALL 
  /MODEL=ALPHA 
  /STATISTICS=DESCRIPTIVE SCALE CORR 
  /SUMMARY=TOTAL.

COMPUTE PostTestIA=PostQ1 + PostQ3 + PostQ5 + PostQ6 + PostQ7 + PostQ8 + PostQ9 + PostQ11 
    + PostQ16 + PostQ17 + PostQ18 + PostQ19 + PostQ20. 
EXECUTE.
